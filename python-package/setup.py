...
setup_args = dict(
    ...
    # "package_data" tells setuptools which extra files to include in the package.
    # If your "employee_events.db" is inside the "employee_events" folder, you can do:
    ...
    # (Optional) If you want to ensure that package_data is included in wheels/sdist:
